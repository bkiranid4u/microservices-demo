package com.kirandev.kafka.admin.clients;

import com.kirandev.configdata.KafkaConfigData;
import com.kirandev.configdata.RetryConfigData;
import com.kirandev.kafka.admin.exception.KafkaClientException;
...
public class KafkaAdminClient {
    ...
    public void createTopics() {
        ...
        try {
            ...
            if (e.getCause() instanceof TopicExistsException) {
                logger.info("Create topic exists exception {}", e.getCause().getMessage());
         }  else{
    ...
    public void checkTopicsCreated() {
        ...
        Long sleepTimeMs = retryConfigData.getSleepTime().toMillis();
    ...
    private HttpStatusCode getSchemaRegistryStatus() {
        try {
            return webClient
                    ...
                    .exchangeToMono(response -> response.toBodilessEntity() // Safely drains and discards body
