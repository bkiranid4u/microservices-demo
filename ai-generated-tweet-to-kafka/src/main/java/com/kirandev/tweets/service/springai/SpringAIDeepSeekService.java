...
@Service
@ConditionalOnProperty(name = "ai-generated-tweet-to-kafka.ai-service", havingValue = "SpringAI-Deepseek")
@Slf4j
public class SpringAIDeepSeekService implements AIService {
    ...
    public SpringAIDeepSeekService(@Qualifier("ollamaChatClient") ChatClient chatClient, AIGeneratedTweetToKafkaConfigData configData) {
